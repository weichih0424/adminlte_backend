...
<html lang="en">
  <head>
	...
	{{-- <link rel="stylesheet" href="css/multiselect-02/style.css"> --}}
		...
		<div class="container">
			<div class="row justify-content-center">
				<div class="col-md-6 text-center mb-5">
					<h2 class="heading-section">Multiselect #02</h2>
				</div>
			</div>
			<div class="row justify-content-center">
				<div class="col-lg-4 col-md-6 d-flex justify-content-center align-items-center">
				    ...
				    <select name="test" multiple="" class="label ui selection fluid dropdown">
